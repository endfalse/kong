...
var HttpRequestFactory = /** @class */ (function () {
    function HttpRequestFactory(config) {
        //默认文件分片上传大小
        ...
        this.uploadNotify = config.uploadNotify;
        this.chunkSize = config.chunkSize;
        this.request = new RequestFactory(config);
    }
    HttpRequestFactory.prototype.create = function () {
        return this.httpRequest;
    };
    HttpRequestFactory.prototype.getError = function (action, option, xhr) {
        var msg;
        if (xhr.response) {
    ...
    HttpRequestFactory.prototype.isNil = function (value) {
        return value === null || value === undefined || isNaN(value);
    };
    //文件切片
    HttpRequestFactory.prototype.sliceFile = function (file, chunkSize) {
    ...
    HttpRequestFactory.prototype.nextProcess = function (xhr_1, option_1) {
    ...
    HttpRequestFactory.prototype.setHeaders = function (xhr, headers, withCredentials) {
    ...
    //执行文件分片上传
    HttpRequestFactory.prototype.uploadCore = function (md5, option, uploadedMap) {
        var _this = this;
     ...
     * @date 2024.11.11
     * */
    HttpRequestFactory.prototype.httpRequest = function (option) {
